...
async def _seed_sarah(s: AsyncSession) -> None:
    ...
    s.add_all(_gen_deposits(cid, pm, 15, _ago(days=500), _ago(days=7), 500, 2000, ip))
    s.add_all(_gen_trades(cid, 80, _ago(days=500), _ago(days=1), 100, 1500))
    s.add_all(_gen_past_withdrawals(
        cid, pm, 8, _ago(days=400), _ago(days=14),
...
async def _seed_james(s: AsyncSession) -> None:
    ...
    s.add_all(_gen_deposits(cid, pm, 20, _ago(days=1000), _ago(days=5), 5000, 25000, ip))
    s.add_all(_gen_trades(cid, 150, _ago(days=1000), _ago(days=1), 500, 8000))
    s.add_all(_gen_past_withdrawals(
        cid, pm, 12, _ago(days=900), _ago(days=21),
...
async def _seed_aisha(s: AsyncSession) -> None:
    ...
    s.add_all(_gen_deposits(cid, pm, 8, _ago(days=220), _ago(days=10), 200, 800, ip))
    s.add_all(_gen_trades(cid, 40, _ago(days=220), _ago(days=2), 50, 500))
    s.add_all(_gen_past_withdrawals(
        cid, pm, 5, _ago(days=180), _ago(days=20),
...
async def _seed_kenji(s: AsyncSession) -> None:
    ...
    s.add_all(_gen_deposits(cid, pm, 12, _ago(days=350), _ago(days=5), 500, 3000, ip))
    s.add_all(_gen_trades(cid, 60, _ago(days=350), _ago(days=1), 200, 2000))
    s.add_all(_gen_past_withdrawals(
        cid, pm, 6, _ago(days=300), _ago(days=15),
...
async def _seed_emma(s: AsyncSession) -> None:
    ...
    s.add_all(_gen_deposits(cid, pm, 6, _ago(days=700), _ago(days=30), 100, 500, ip, "GBP"))
    s.add_all(_gen_trades(cid, 25, _ago(days=700), _ago(days=5), 20, 200))
    s.add_all(_gen_past_withdrawals(
        cid, pm, 4, _ago(days=600), _ago(days=45),
...
async def _seed_raj(s: AsyncSession) -> None:
    ...
    s.add_all(_gen_deposits(cid, pm, 18, _ago(days=350), _ago(days=3), 1000, 5000, ip))
    s.add_all(_gen_trades(cid, 120, _ago(days=350), _ago(days=1), 200, 3000))
    s.add_all(_gen_past_withdrawals(
        cid, pm, 10, _ago(days=300), _ago(days=10),
