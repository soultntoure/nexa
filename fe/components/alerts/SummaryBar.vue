...
<template>
  <div class="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
    <div class="flex items-center gap-3 rounded-xl border border-amber-200 bg-amber-50 p-4" title="Withdrawals flagged for manual review due to medium-risk signals">
